# 🚀 Прогнозирование Финальной Цены Контракта (Тендерный Анализ)
...
Наша текущая задача: Выявить и включить те прогностические факторы (переменные X), которые позволят модели объяснить не менее 70-80% (R² $\approx$ 0.70-0.80) вариативности в проценте снижения цены.
...
Для представления методологии проекта была разработана примереная инфографика, которая показывает, как сырые данные трансформируются в конечный, измеримый прогноз.
