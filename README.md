...
Идея проекта строится на гипотезе о том, что **прогноз финальной цены** должен основываться не только на моментальных характеристиках (как количество участников), но и на **историческом поведении ключевых игроков** (Заказчика и Поставщика).

**Следовательно, задача Data Analyst'а** заключалась в том, чтобы трансформировать базовые входные поля в **сложные агрегированные признаки**, которые несет в себе информацию о прошлом опыте.
